...
|SRC | CTRL | LEN | DEV_ID | - | DEV_ID | - | - | - | |WATER TEMP | | | CYCLE1 ROOM1 TEMP ? |  | | | | | | | CYCLE1 ROOM1 SET TEMP | | | | | | | | WATER SET TEMP HEAT| | | WATER SET TEMP COOL | | | | | | WATER PUMP SPEED | | WATER FLOW (1 digit) | | IDU CAPACITY? | ? | | ? | ? | CRC | 
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
