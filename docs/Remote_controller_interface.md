...
|SRC | CTRL | LEN | DEV_ID | - | DEV_ID | | OP | - | | MODE | CYCLE MODE | WATER SET TEMP CYCLE1 | WATER SET TEMP CYCLE2 | DHW SET TEMP | POOL SET TEMP | ERROR CODE | | | CYCLE1 ROOM1 SET TEMP | CYCLE2 ROOM1 SET TEMP| CYCLE1 ROOM2 SET TEMP | CYCLE2 ROOM2 SET TEMP | CYCLE1 ROOM3 SET TEMP| CYCLE2 ROOM3 SET TEMP| CYCLE1 ROOM4 SET TEMP | CYCLE2 ROOM4 SET TEMP | ROOM ENABLE | | DHW CONFIG | PUMP STATUS | WATERPUMP CONFIG | | | | | | |  | |  |  | | | | | | CRC | 
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
|SRC | CTRL | LEN | DEV_ID | - | DEV_ID | | OP | - | |  |   |  |  |  |  |  | | |  | |  |  | | || MIN WATER SUPPLY TEMP HEAT CYCLE1 | MAX WATER SUPPLY TEMP HEAT CYCLE1 | | | MIN WATER SUPPLY T HEAT CYCLE2 | MAX WATER SUPPLY TEMP HEAT CYCLE2 | |  |  | | | | | | CRC | 
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
|SRC | CTRL | LEN | DEV_ID | - | DEV_ID | - | - | - | | WATER TEMP | TOW2 TEMP | TOW3 TEMP | CYCLE1 ROOM1 TEMP | CYCLE1 ROOM2 TEMP | CYCLE1 ROOM3 TEMP | CYCLE1 ROOM4 TEMP | CYCLE2 ROOM1 TEMP | CYCLE2 ROOM2 TEMP | CYCLE2 ROOM3 TEMP | CYCLE2 ROOM4 TEMP | CYCLE1 ROOM1 SET TEMP | CYCLE1 ROOM2 SET TEMP | CYCLE1 ROOM3 SET TEMP | CYCLE1 ROOM4 SET TEMP | CYCLE2 ROOM1 SET TEMP | CYCLE2 ROOM2 SET TEMP | CYCLE2 ROOM3 SET TEMP | CYCLE2 ROOM4 SET TEMP | WATER SET TEMP HEAT| | | WATER SET TEMP COOL |  |  | DHW TEMP | | | WATER PUMP SPEED | | WATER FLOW (1 digit) | UNKNOWN1 | UNKNONWN2 | UNKNOWN3 | | ? | ? | CRC | 
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
...
NOTE: UNKNOWN1 ADN UNKNOWN3 CHANGE WHEN THE SYSTEM SWITCH FROM HEATING TOOM TO DHW PRODUCTION:
UNKNWON1 8->136
UNKNOWN3 6->0
UNKNWON2 VALUE IS 4, WHEN ENDING DHW PHASE SWITCH FEW TIMES BETWEEN 4 AND 6
